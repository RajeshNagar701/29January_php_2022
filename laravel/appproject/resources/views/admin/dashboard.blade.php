                            ...
                            <ul class="chat-box">
                                <li class="left clearfix">
                                    <span class="chat-img pull-left">
                                        <img src={{url('admin_public/assets/img/1.png')}}" alt="User" class="img-circle" />
                                    </span>
                                    <div class="chat-body">                                        
                                ...
                                <li class="right clearfix">
                                    <span class="chat-img pull-right">
                                        ...
                                        <img src={{url('admin_public/assets/img/2.png')}}" alt="User" class="img-circle" />
                                    </span>
                                ...
                                <li class="left clearfix">
                                    <span class="chat-img pull-left">
                                         <img src={{url('admin_public/assets/img/3.png')}}" alt="User" class="img-circle" />
                                    </span>
                                    <div class="chat-body clearfix">
                                ...
                                <li class="right clearfix">
                                    <span class="chat-img pull-right">
                                         <img src={{url('admin_public/assets/img/4.png')}}" alt="User" class="img-circle" />
                                    </span>
                                    <div class="chat-body clearfix">
...
<span class="label label-danger">Danger</span>
    ...
    <script src={{url('admin_public/assets/js/jquery.metisMenu.js')}}></script>
     ...
     <script src={{url('admin_public/assets/js/morris/raphael-2.1.0.min.js')}}></script>
    <script src={{url('admin_public/assets/js/morris/morris.js')}}></script>
      <!-- CUSTOM SCRIPTS -->
