	...
	<div class="container-fluid pt-lg-5">
				...
				<div class="tech-btm">
					...
					<div class="blog-grids row mb-3">
						<div class="col-4 pr-0 blog-grid-left">
							<a href="#">
								<img src={{url('web_public/images/blog1.jpg')}} class="img-fluid" alt="">
							</a>
						</div>
					...
					<div class="blog-grids row mb-3">
						<div class="col-4 pr-0 blog-grid-left">
							<a href="#">
								<img src={{url('web_public/images/blog2.jpg')}} class="img-fluid" alt="">
							</a>
						</div>
						<div class="col-8 blog-grid-right">
					...
					<div class="blog-grids row">
						<div class="col-4 pr-0 blog-grid-left">
							<a href="#">
								<img src={{url('web_public/images/blog3.jpg')}} class="img-fluid" alt="">
							</a>
						</div>
						<div class="col-8 blog-grid-right">
		...
		<div class="footer-cpy text-center pt-sm-5 mt-sm-5 mt-4 pt-3">
			<div class="w3layouts-agile-copyrightbottom">
				<p>© 2022 Book My Car. All Rights Reserved | Design by
					<a href="#">Raj Nagar</a>
				</p>
...
<!-- js-scripts -->		
	...
	<!-- js -->
	<script type="text/javascript" src={{url('web_public/js/jquery-2.1.4.min.js')}}></script>
	<script type="text/javascript" src={{url('web_public/js/bootstrap.js')}}></script> <!-- Necessary-JavaScript-File-For-Bootstrap --> 
	<!-- //js -->
	
	<!-- carousel -->
	<script src={{url('web_public/js/owl.carousel.js')}}></script>
	<script>
	...
	<!--slider-->
	<script src={{url('web_public/js/responsiveslides.min.js')}}></script>
	<script>
		$(function () {
			// Slideshow 1
	...
	<script src={{url('web_public/js/SmoothScroll.min.js')}}></script>
	<script type="text/javascript" src={{url('web_public/js/move-top.js')}}></script>
	<script type="text/javascript" src={{url('web_public/js/easing.js')}}></script>
