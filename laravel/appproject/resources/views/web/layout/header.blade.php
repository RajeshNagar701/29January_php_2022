...
<title>Taxi Cab</title>
	...
	<!-- css files -->
	<link rel="stylesheet" href={{url('web_public/css/bootstrap.css')}}> <!-- Bootstrap-Core-CSS -->
	<link rel="stylesheet" href={{url('web_public/css/style.css')}} type="text/css" media="all" /> <!-- Style-CSS --> 
	<link rel="stylesheet" href={{url('web_public/css/fontawesome-all.css')}}> <!-- Font-Awesome-Icons-CSS -->
	<!-- //css files -->
					...
					<ul class="navbar-nav mx-auto">
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu" aria-labelledby="navbarDropdown">
								...
								<a class="dropdown-item text-center" href={{url('mybooking')}}>My Booking</a>
							</div>
						</li>
						<?php
						}
