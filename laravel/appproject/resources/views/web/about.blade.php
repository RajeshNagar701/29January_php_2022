				...
				<div class="carousel-item active">
					<div class="row">
						<div class="col-md-4 col-sm-6 slidering">
							<div class="thumbnail"><img src={{url('web_public/images/1.png" alt="Image" style="max-width:100%;"></div>
							<h5 class="my-2 text-center text-uppercase">Mini Taxi </h5>
						</div>
						<div class="col-md-4 col-sm-6 slidering">
							<div class="thumbnail"><img src={{url('web_public/images/2.png" alt="Image" style="max-width:100%;"></div>
							<h5 class="my-2 text-center text-uppercase">Prime Taxi </h5>
						</div>
						<div class="col-md-4 col-sm-6 slidering">
							<div class="thumbnail"><img src={{url('web_public/images/3.png" alt="Image" style="max-width:100%;"></div>
		...
		<div class="row text-center">
			<div class="col-lg-3 col-6 team-grids">
				<div class="team-effect">
					<img src={{url('web_public/images/team1.jpg" alt="img" class="img-fluid">
				</div>
				<!-- team text -->
			...
			<div class="col-lg-3 col-6 team-grids">
				<div class="team-effect">
					<img src={{url('web_public/images/team2.jpg" alt="img" class="img-fluid">
				</div>
				<!-- team text -->
				<div class="footerv2-w3ls mt-3">
					<h4>Laura Hill</h4>
			...
			<div class="col-lg-3 col-6 team-grids mt-lg-0 mt-5">
				<div class="team-effect">
					<img src={{url('web_public/images/team3.jpg" alt="img" class="img-fluid">
				</div>
				<!-- team text -->
				<div class="footerv2-w3ls mt-3">
					<h4>Smith Kevin</h4>
			...
			<div class="col-lg-3 col-6 team-grids mt-lg-0 mt-5">
				<div class="team-effect">
					<img src={{url('web_public/images/team4.jpg" alt="img" class="img-fluid">
				</div>
				<!-- team text -->
				<div class="footerv2-w3ls mt-3">
					<h4>Thomson Doe</h4>
