	...
	<div class="container py-lg-5">
		...
		<div class="row service-grids">
			...
			<div class="col-lg-2 col-6">
				<img src={{url('web_public/images/1.png" alt="" class="img-fluid" />
				<img src={{url('web_public/images/2.png" alt="" class="img-fluid" />
				<img src={{url('web_public/images/3.png" alt="" class="img-fluid" />
			</div>
			<div class="col-lg-2 col-6">
				<img src={{url('web_public/images/3.png" alt="" class="img-fluid" />
				<img src={{url('web_public/images/1.png" alt="" class="img-fluid" />
